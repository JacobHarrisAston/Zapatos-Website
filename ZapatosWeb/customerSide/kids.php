...
<body>
   ...
   <section class="product_list">
    ...
    if($str == "" OR $str==" "){
        ...
        $query = "SELECT * FROM `kids_items` WHERE `product_name` LIKE '%$str%'";     
    ...
    <!-- main page starts -->
        ...
        <div class="card">
            <?php
                include 'config.php';
                $temp_article_no = "k-1";
                $sql = "SELECT * FROM kids_items where article_no='$temp_article_no'";
                $result= mysqli_query($conn,$sql);
                $row = mysqli_fetch_array($result);?>
            <div class="image"><img src="c-img/kids-shoes/<?php echo $row['photo']?>"></div>
            ...
            <div><a href="kShoes_details.php?ID=k-1"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="kShoes_details.php?ID=k-2"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="kShoes_details.php?ID=k-3"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="kShoes_details.php?ID=k-4"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="kShoes_details.php?ID=k-5"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="kShoes_details.php?ID=k-6"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="kShoes_details.php?ID=k-7"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="kShoes_details.php?ID=k-8"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="kShoes_details.php?ID=k-9"><button class="view_product">View Product</button></a></div>
        </div>

        <div class="card">
            <?php
                include 'config.php';
                $temp_article_no = "k-10";
                $sql = "SELECT * FROM kids_items where article_no='$temp_article_no'";
                $result= mysqli_query($conn,$sql);
                $row = mysqli_fetch_array($result);?>
            <div class="image"><img src="c-img/kids-shoes/<?php echo $row['photo']?>"></div>
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="kShoes_details.php?ID=k-10"><button class="view_product">View Product</button></a></div>
        </div>
