...
<body>
    ...
    if($str == "" OR $str==" "){
        ...
        $query = "SELECT * FROM `women_items` WHERE `product_name` LIKE '%$str%'";     
    ...
    <!-- main page starts -->
        ...
        <div class="card">
            <?php
                include 'config.php';
                $temp_article_no = "w-1";
                $sql = "SELECT * FROM women_items where article_no='$temp_article_no'";
                $result= mysqli_query($conn,$sql);
                $row = mysqli_fetch_array($result);?>
            <div class="image"><img src="c-img/women-shoes/<?php echo $row['photo']?>"></div>
            <div class="title"><?php echo $row['product_name']?></div>
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="wShoes_details.php?ID=w-1"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="wShoes_details.php?ID=w-2"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="wShoes_details.php?ID=w-3"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="wShoes_details.php?ID=w-4"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="wShoes_details.php?ID=w-5"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="wShoes_details.php?ID=w-6"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="wShoes_details.php?ID=w-7"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="wShoes_details.php?ID=w-8"><button class="view_product">View Product</button></a></div>
        </div>
        ...
        <div class="card">
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="wShoes_details.php?ID=w-9"><button class="view_product">View Product</button></a></div>
        </div>

        <div class="card">
            <?php
                include 'config.php';
                $temp_article_no = "w-10";
                $sql = "SELECT * FROM women_items where article_no='$temp_article_no'";
                $result= mysqli_query($conn,$sql);
                $row = mysqli_fetch_array($result);?>
            <div class="image"><img src="c-img/women-shoes/<?php echo $row['photo']?>"></div>
            ...
            <div class="price"><h4>£<?php echo $row['cost']?></h4></div>
            <div class="article_no"><p><?php echo $row['article_no']?></p></div>
            <div><a href="wShoes_details.php?ID=w-10"><button class="view_product">View Product</button></a></div>
        </div>
