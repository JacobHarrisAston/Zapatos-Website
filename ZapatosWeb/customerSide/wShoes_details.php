<?php
    if(isset($_GET['ID'])){
        ...
        $sql = "SELECT * FROM women_items where article_no='$ID'";
...
<body>
    ...
    <main>
        <div class="flex-container">
            <div class="big_img"><img src="c-img/women-shoes/<?php echo $row['photo']?>"></div>
            <div class="details">
                ...
                <form action="cartSession.php" method="post" class="form_details">
                    <div class="size">
                      ...
                      <div class="quantity">
                        ...
                        <input type="hidden" name="type" value="female"></input>
